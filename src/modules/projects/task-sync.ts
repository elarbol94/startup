...
// Shared, synchronous hierarchy rollups for project tasks. They use the global
// connection, which participates in any open better-sqlite3 transaction.

export const SORT_GAP = 1000;

export function nextSortOrder(columnId: string, parentTaskId: string | null): number {
