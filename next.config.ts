...
const nextConfig: NextConfig = {
  ...
  serverExternalPackages: ["yjs", "@tiptap/y-tiptap", "better-sqlite3", "playwright", "@citation-js/core", "@citation-js/plugin-csl", "sqlite-vec", "@huggingface/transformers", "@hocuspocus/server", "crossws"],
